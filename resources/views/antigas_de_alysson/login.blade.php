            ...
            <div class=" col-12 col-sm-7 login-image-container">
             ...
             <div class="col-12 col-sm-5 m-0  m-sm-4 p-0 background-color login-card-custom">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3 px-4 px-sm-5 d-flex justify-content-between align-items-center">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                            <label class="form-check-label" for="remember">Manter-me conectado</label>
                        </div>
                        <a href="{{ route('password.request') }}" class="nunita-bold">Esqueci a senha</a>
                    </div>
...
@if(session('login_error'))
  <div class="text-danger text-center mt-3">{{ session('login_error') }}</div>
@endif


                <div class="mt-3 text-center form-text">
                <p class="nunita-bold">Não possui conta? <a href="/cadastro">Clique aqui</a></p>
